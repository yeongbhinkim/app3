...
//  }
  ...
  public String edit(
    ...
    notice.setAuthor(editForm.getAuthor());
  ...
  public String list(Model model) {
    ...
    for (Notice notice : list) {
      ...
      item.setCdata(notice.getCdata().toLocalDate().format(DateTimeFormatter.ofPattern("yyyy/MM/dd"))); //LocalDateTime =>LocalData
      item.setCtime(notice.getCdata().toLocalTime().format(DateTimeFormatter.ofPattern("H:m:s")));
